...
import com.followinsider.data.forms.f345.OwnershipForm;
import com.followinsider.data.forms.f345.footnote.Footnote;
import com.followinsider.data.forms.f345.footnote.FootnoteContainer;
import com.followinsider.data.forms.f345.footnote.FootnoteID;
import com.followinsider.data.forms.f345.footnote.FootnoteValue;
import com.followinsider.data.forms.f345.owner.Issuer;
import com.followinsider.data.forms.f345.owner.Relationship;
import com.followinsider.data.forms.f345.owner.ReportingOwner;
import com.followinsider.data.forms.f345.transaction.PostTransactionAmounts;
...
import com.followinsider.data.forms.f345.transaction.nonderivative.NonDerivativeTransaction;
import com.followinsider.data.forms.f345.transaction.nonderivative.NonDerivativeTransactionAmounts;
...
public class FormMapper {
    ...
    public Form mapOwnershipDoc(OwnershipDoc doc) {

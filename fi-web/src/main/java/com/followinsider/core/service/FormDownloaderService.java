...
import com.followinsider.core.util.FormParser;
import com.followinsider.core.entity.FiscalQuarter;
import com.followinsider.core.entity.Form;
import com.followinsider.core.repository.FailedFormRefRepository;
...
public class FormDownloaderService {
    ...
    private void downloadByRefs(String source, List<FormRef> refs) {
        ...
        entitySaverService.saveForms(forms, source);
    }
        ...
        return refs.parallelStream()
                .map(ref -> {
                    try {
                        ...
                        return FormParser.parseOwnershipDoc(doc);

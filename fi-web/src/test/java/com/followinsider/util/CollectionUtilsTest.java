...
public class CollectionUtilsTest {
    ...
    public void testMap() {
        ...
        assertEquals(List.of(2, 4, 6), CollectionUtils.map(nums, num -> num * 2));
    }
    ...
    public void testPartition() {
        ...
        List<List<Integer>> groups = CollectionUtils.partition(nums, 4);
    ...
    public void testDivide() {
        ...
        List<List<Integer>> groups = CollectionUtils.divide(nums, 4);
